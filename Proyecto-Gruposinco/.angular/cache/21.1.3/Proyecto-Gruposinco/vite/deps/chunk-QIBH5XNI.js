  ...
  return function() {
    ...
    for (let i = 0; i < arguments.length; i++) {
      if (typeof _arguments[i] === "function") {
        if (blockUntilFirst) {
          macrotask ||= run(() => Zone.current.scheduleMacroTask("firebaseZoneBlock", noop2, {}, noop2, noop2));
        }
...
//# sourceMappingURL=chunk-QIBH5XNI.js.map
