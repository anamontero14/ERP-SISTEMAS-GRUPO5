...
export class PedidoRepository implements IPedidoRepository {
    ...
    private pedidosMock: clsPedido[] = [
        ...
        new clsPedido(2, 2, 1, new Date('2024-01-15'), 'enviado', 'Fragil', false),
        ...
        new clsPedido(5, 1, 8, new Date('2024-02-10'), 'enviado', '', false),
        ...
        new clsPedido(9, 1, 7, new Date('2024-02-16'), 'enviado', '', false),
    ...
    // UpdateEstado Pedido
    // return 1 = OK
    async cambiarEstadoPedido(idPedido: number, nuevoEstado: "pedido" | "enviado" | "entregado"): Promise<number> {
        const pedido = this.pedidosMock.find(p => p.IdPedido === idPedido);
        if (pedido) {
